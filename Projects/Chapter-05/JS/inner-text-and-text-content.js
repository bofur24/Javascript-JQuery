...
var showInnerText = firstItem.innerText;            // Get bvalue of innerText

// Show the content of these two properties at the end of the list
var msg = '<p>texstContent: ' + showTextContent + '</p>';
msg += '<p>innerText: ' + showInnerText + '</p>';

var el = document.getElementById('scriptResults');
el.innerHTML = msg;

firstItem.textContent = 'sourdough bread';          // Update the first list